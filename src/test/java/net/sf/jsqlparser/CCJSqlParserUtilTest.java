...
public class CCJSqlParserUtilTest {
	...
	public void testParseExpression3() throws Exception {
		...
		public void testParseExpression4() throws Exception {
			Expression result = CCJSqlParserUtil.parseExpression("2*(a/0)");
			assertEquals("2 * (a / 0)", result.toString());
			assertTrue(result instanceof Multiplication);
			Multiplication mult = (Multiplication)result;
			assertTrue(mult.getLeftExpression() instanceof LongValue);
			assertTrue(mult.getRightExpression() instanceof Parenthesis);
		...
		public void testParseExpression5() throws Exception {
			Expression result = CCJSqlParserUtil.parseExpression("2*(0/a)");
			assertEquals("2 * (0 / a)", result.toString());
			assertTrue(result instanceof Multiplication);
			Multiplication mult = (Multiplication)result;
			assertTrue(mult.getLeftExpression() instanceof LongValue);
			assertTrue(mult.getRightExpression() instanceof Parenthesis);
