...
public class TablesNamesFinderTest {
    ...
    public void testSelectDistinct() throws Exception {
        ...
        List<String> tableList = tablesNamesFinder.getTableList(selectStatement);
        assertEquals(1, tableList.size());
        assertEquals("Orders", (String) tableList.get(0));
    }
    @Test
    public void testGetTableListWithBetween() throws Exception {
        String sql = "SELECT * FROM MY_TABLE2 WHERE a BETWEEN 0 AND 2";
        net.sf.jsqlparser.statement.Statement statement = pm.parse(new StringReader(sql));
    ...
    @Test
    public void testJion() throws Exception {
        String sql = "select customerid,name,birthdate,frequentflieron from customers join flewon";
        net.sf.jsqlparser.statement.Statement statement = pm.parse(new StringReader(sql));
        ...
        assertEquals("customers", (String) tableList.get(0));
    }

    @Test
    public void testSubJion() throws Exception {
        String sql = "select b2.*, bp2.product_id from Bugs b2 JOIN BugsProducts bp2 ON b2.bug_id = bp2.bug_id";
        net.sf.jsqlparser.statement.Statement statement = pm.parse(new StringReader(sql));
        ...
        List<String> tableList = tablesNamesFinder.getTableList(selectStatement);
        assertEquals(2, tableList.size());
        assertEquals("Bugs", (String) tableList.get(0));
    }
    @Test
    public void testLike() throws Exception {
        String sql = "select name from customers where length(name)>14 and name like'_l%'";
        net.sf.jsqlparser.statement.Statement statement = pm.parse(new StringReader(sql));
    ...
    public void testMultiplication() throws Exception {
        String sql = "UPDATE MY_TABLE1 SET a = a*2";
        net.sf.jsqlparser.statement.Statement statement = pm.parse(new StringReader(sql));
    ...
    public void testBinaryExpression() throws Exception {
        String sql = "UPDATE MY_TABLE1 SET a = a&2, b = b/5";
        net.sf.jsqlparser.statement.Statement statement = pm.parse(new StringReader(sql));
